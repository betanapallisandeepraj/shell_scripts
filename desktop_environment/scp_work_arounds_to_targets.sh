...
# ip1="192.168.153.1"
# ip2="10.223.249.22"
lede="/mnt/2f085d66-eab7-49a7-9190-206bc3512f78/lede"
luci="/mnt/2f085d66-eab7-49a7-9190-206bc3512f78/luci"
...
# scp_to_both_target $lede/package/base-files/files/sbin/wifi /sbin/wifi
# scp_to_both_target $luci/modules/luci-mod-admin-full/luasrc/model/cbi/admin_network/wifi.lua /usr/lib/lua/luci/model/cbi/admin_network/wifi.lua
# scp_to_target1 $lede/package/kernel/mac80211/files/lib/netifd/wireless/mac80211.sh /lib/netifd/wireless/mac80211.sh
# scp_to_target1 $lede/package/network/services/hostapd/files/hostapd.sh /lib/netifd/hostapd.sh

scp_to_target1 $luci/modules/luci-mod-system/htdocs/luci-static/resources/view/system/flash.js /www/luci-static/resources/view/system/flash.js
